...
describe('Storage Functions', () => {
  ...
  describe('updateUserProgressLocal', () => {
    ...
    it('should update difficulty based on answer correctness', () => {
      ...
      expect(incorrectProgress.difficulty).toBeLessThan(moreCorrectProgress.difficulty)
    })
    ...
    it('should update review dates', () => {
      ...
      expect(new Date(progress.nextReview).getTime()).toBeGreaterThan(new Date(progress.lastReview).getTime())
    })
